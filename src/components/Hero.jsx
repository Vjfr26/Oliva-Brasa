    ...
    <section id="inicio" ref={ref} className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <motion.div style={{ y: bgY }} className="absolute inset-0 -z-10">
        <motion.img
          ...
          alt="Interior elegante del restaurante Oliva & Brasa"
      ...
      >
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl">
          ...
          >
            ...
            <em className="text-gold-light italic">hecho experiencia</em>
          </motion.h1>

          <motion.p variants={item} className="mt-7 max-w-xl text-lg leading-relaxed text-cream/70">
            Ingredientes de temporada, fuego lento y una pasión que se sirve en
            cada plato. Bienvenido a Oliva &amp; Brasa.
          </motion.p>
          ...
          {/* Tarjeta flotante de valoración */}
          <motion.div
            variants={item}
          ...
          >
            ...
            <p className="text-sm text-cream/80">
              <strong className="text-cream">4.9 / 5</strong> · más de 2.400 reseñas
            </p>
          </motion.div>
        </motion.div>
      </motion.div>
